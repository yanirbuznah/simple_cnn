...
CNN_ADAPTIVE_LEARNING_RATE_MODE = AdaptiveLearningRateMode.PREDEFINED_DICT
CNN_ADAPTIVE_LEARNING_RATE_FORMULA = lambda epoch: 0.005 * np.exp(-0.0001 * epoch)
...
FC_ADAPTIVE_LEARNING_RATE_MODE = AdaptiveLearningRateMode.PREDEFINED_DICT
FC_ADAPTIVE_LEARNING_RATE_FORMULA = lambda epoch: 0.005 * np.exp(-0.0001 * epoch)
